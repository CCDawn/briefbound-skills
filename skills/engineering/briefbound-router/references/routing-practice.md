...
| 部署/启动/运行故障或部署验证 | `briefbound-runtime-operations` | FAST/COMPACT | 环境/代码分流与三级验证 |
...
| 明确要求 memory、dashboard 或跨会话恢复 | `briefbound-project-memory` | FAST/COMPACT | 持久 delta 或恢复上下文 |
