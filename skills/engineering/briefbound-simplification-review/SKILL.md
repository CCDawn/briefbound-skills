---
name: briefbound-simplification-review
...
- Route Out: `briefbound-pr-review`、`briefbound-performance-engineering`、对应开发 owner、`briefbound-planning`、`briefbound-router` 或 BLOCKED。
