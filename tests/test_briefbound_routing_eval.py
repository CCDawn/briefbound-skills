...
SCRIPT_PATH = Path(__file__).resolve().parents[1] / "scripts" / "run_briefbound_routing_eval.py"
SPEC = importlib.util.spec_from_file_location("run_briefbound_routing_eval", SCRIPT_PATH)
...
class RoutingEvalTests(unittest.TestCase):
    def test_parse_events_counts_unique_commands_and_skill_reads(self) -> None:
        stream = "\n".join(
            [
                ...
                '{"type":"item.started","item":{"id":"cmd-1","type":"command_execution","command":"Get-Content C:\\\\Users\\\\me\\\\.codex\\\\skills\\\\briefbound-router\\\\SKILL.md"}}',
                '{"type":"item.completed","item":{"id":"cmd-1","type":"command_execution","command":"Get-Content C:\\\\Users\\\\me\\\\.codex\\\\skills\\\\briefbound-router\\\\SKILL.md","aggregated_output":"---\\nname: briefbound-router\\n---\\n# Briefbound Router\\n","exit_code":0,"status":"completed"}}',
        ...
        self.assertEqual(skill_reads, ["briefbound-router"])
    ...
    def test_parse_events_accepts_codex_double_escaped_windows_paths(self) -> None:
        stream = (
            ...
            '\\\\\\\\briefbound-project-review\\\\\\\\SKILL.md","exit_code":0,'
        ...
        self.assertEqual(skill_reads, ["briefbound-project-review"])

    def test_parse_events_does_not_count_failed_skill_read(self) -> None:
        stream = "\n".join(
            [
                '{"type":"item.started","item":{"id":"cmd-1","type":"command_execution",'
                '"command":"Get-Content C:\\\\Users\\\\me\\\\.codex\\\\skills\\\\briefbound-router\\\\SKILL.md"}}',
                '{"type":"item.completed","item":{"id":"cmd-1","type":"command_execution",'
                '"command":"Get-Content C:\\\\Users\\\\me\\\\.codex\\\\skills\\\\briefbound-router\\\\SKILL.md",'
    ...
    def test_parse_events_does_not_count_skill_paths_from_file_listing(self) -> None:
        stream = (
            '{"type":"item.completed","item":{"id":"cmd-1","type":"command_execution",'
            '"command":"rg --files -g skills/**/briefbound-ui-design/SKILL.md '
            '-g skills/**/briefbound-frontend-engineering/SKILL.md",'
            '"aggregated_output":"skills/engineering/briefbound-ui-design/SKILL.md\\n'
            'skills/engineering/briefbound-frontend-engineering/SKILL.md\\n",'
            '"exit_code":0,"status":"completed"}}'
        )
    ...
    def test_case_turns_keeps_initial_contract_and_followups(self) -> None:
        case = {
            ...
            "prompt": "先探查并对齐。",
            "expected_skill_reads": ["briefbound-router"],
            "forbidden_skill_reads": ["briefbound-ui-design"],
            "max_commands": 4,
            ...
            "followups": [
                {
                    ...
                    "expected_skill_reads": ["briefbound-ui-design"],
                    "forbidden_skill_reads": ["briefbound-router"],
                    "max_commands": 4,
                    "expected_final_any": ["briefbound-ui-design"],
                }
            ],
        }
        ...
        self.assertEqual(turns[1]["expected_skill_reads"], ["briefbound-ui-design"])
    ...
    def test_run_case_evaluates_initial_and_followup_turns(self) -> None:
        ...
        initial_output = "\n".join(
            [
                ...
                '{"type":"item.completed","item":{"id":"cmd-1","type":"command_execution",'
                '"command":"Get-Content C:\\\\Users\\\\me\\\\.codex\\\\skills'
                '\\\\briefbound-router\\\\SKILL.md","aggregated_output":"---\\nname: briefbound-router\\n---\\n",'
                '"exit_code":0,"status":"completed"}}',
        ...
        followup_output = "\n".join(
            [
                ...
                '"command":"Get-Content C:\\\\Users\\\\me\\\\.codex\\\\skills'
                '\\\\briefbound-ui-design\\\\SKILL.md","aggregated_output":"---\\nname: briefbound-ui-design\\n---\\n",'
                '"exit_code":0,"status":"completed"}}',
                '{"type":"item.completed","item":{"id":"msg-2","type":"agent_message",'
                '"text":"选择 briefbound-ui-design 形成交互契约。"}}',
            ]
        )
        case = {
            "id": "alignment-then-route",
