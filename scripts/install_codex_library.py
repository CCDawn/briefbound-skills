...
- Before development or planning, apply an alignment-value gate. First use one narrow read-only probe when existing behavior, tests, or project rules can resolve the choice. Ask one compact Chinese-first group of recommended questions only when evidence remains insufficient and the answer could materially change behavior, interaction, data, compatibility, acceptance evidence, or edit scope; otherwise proceed.
